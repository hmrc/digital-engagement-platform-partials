    ...
    "HMRC ChatSkin response" when {
        ...
        "successfully rendered" should {
            ...
            "include url in hmrc-webchat-tag" in {
                document.getElementById("hmrc-webchat-tag").toString should include ("http://localhost:9193/engagement-platform-skin/assets/javascripts/bundle/hmrcChatSkin.js")
            }
        }
    }
}